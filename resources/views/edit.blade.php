            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        @csrf 
                        <!-- @method('PUT')
                        action="{{ url('update_data/'.Auth::user()->id ) }}" -->
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" value="{{ Auth::user()->password }}" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <select name="living_place" value="{{ Auth::user()->living_place }}"  style="width: 10vw;text-align: center;" id="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" value="{{ Auth::user()->phone }}" class="form-control" name="phone" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                               <select name="gender" value="{{ Auth::user()->gender }}" style="width: 10vw;text-align: center;" id="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="uni" type="text" value="{{ Auth::user()->uni }}" class="form-control" name="uni" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="bio" type="text" value="{{ Auth::user()->bio }}" class="form-control" name="bio" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6"> 
                                <input id="profission" type="text" value="{{ Auth::user()->profission }}" class="form-control" name="profission" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birthdate" value="{{ Auth::user()->birthdate }}" type="date" class="form-control" name="birthdate" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="img" type="file" value="{{ Auth::user()->img }}" class="form-control" name="img">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lang" type="text" value="{{ Auth::user()->lang }}" class="form-control" name="lang" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="skills" type="text" value="{{ Auth::user()->skills }}" class="form-control" name="skills" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="activity" type="text" value="{{ Auth::user()->activity }}" class="form-control" name="activity" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="linkedIn_acc" type="text" value="{{ Auth::user()->linkedIn_acc }}" class="form-control" name="linkedIn_acc">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="github_link" type="text" value="{{ Auth::user()->github_link }}" class="form-control" name="github_link">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="sof_acc" type="text" value="{{ Auth::user()->sof_acc }}" class="form-control" name="sof_acc">
                            </div>
                        </div>
